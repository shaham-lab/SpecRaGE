...
from _models.siamese_model import SiameseNet
from _losses.siamese_loss import ContrastiveLoss
...
class SiameseTrainer:
    ...
    def train(self, X: torch.Tensor, architecture: dict) -> SiameseNet:
        """
        ...
        self.siamese_net = SiameseNet(architecture, input_dim=self.X.shape[1]).to(
            self.device
        )
    ...
    def _get_knn_pairs(self) -> list:
        ...
        print("Building pairs dataset for the siamese network ...")
